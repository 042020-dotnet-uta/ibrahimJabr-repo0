    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            { // using while loop to run the rounds until one player reaches a score of 2.
                player1.curntRound = RPSGenerator(); // generate r/p/s to store into playerCurntround.
                player2.curntRound = RPSGenerator();
                if (player1.curntRound == "rock")
                { // conditionals to check who won each round. If player one has a "rock"
                    if (player2.curntRound == "paper")
                    ...
                    else if (player2.curntRound == "scissor")
                    {
                ...
                else if (player1.curntRound == "paper")
                {
                    if (player2.curntRound == "rock")
                    {
